...
public class tabledata_fetching 
{
	...
	//	@Ignore
		...
		public void _3_WebTableHandingExample1()
		{
			...
			List<WebElement> desertListElement = driver.findElements(By.xpath("//tr[@class='ng-star-inserted']/td[text()='"+dessertName+"']//following-sibling::td[text()]"));
			
			System.out.println("The nutritional breakup for the desert \""+dessertName+"\" as below");
			for (int i = 0; i < desertListElement.size(); i++) 
			{ 
				System.out.println((i+1) + ". " + desertListElement.get(i).getText());
			}
